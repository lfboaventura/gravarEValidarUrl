<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    <a href=" {{ route('home') }} " class="navbar-brand col-md-3 col-lg-2 mr-0 px-3 bg-secondary">
    ...
    @auth
    <h5 class="navbar-hearder-title">&nbsp&nbsp @yield('content_header_title')</h5>
    ...
    <ul class="navbar-nav px-3">
        <li class="nav-item text-nowrap">
            <a class="nav-link navbar-hearder-title-" href="{{ route('logout') }}">
                Logout
                &nbsp&nbsp&nbsp
